...
$query_RS_ExtinguisherHeads = "SELECT extinguisher_heads_id, ext_head_brandname FROM tbl_extinguisher_heads ORDER BY ext_head_brandname ASC";
                            ...
                            <div class="block-header">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="card">
                                            <div class="header">
                                                <h2><?php echo $ExtinguisherHeadsEdit ?></h2>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                               <?php echo $ExtinguisherHeadsPlaceholder ?>
                            </h2>
