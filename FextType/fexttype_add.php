...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "fexttype_add")) {
  $insertSQL = sprintf("INSERT INTO tbl_fext_type (fext_type) VALUES (%s)",
...
<?php require_once('../lang/el.php'); ?>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
                        <form ACTION="fexttype_add.php" id="fexttype_add" method="POST" name="fexttype_add">
                            <div class="row clearfix">
                                <div class="col-md-12">
                      ...
                      <div class="col-xs-6 js-sweetalert">
                       ...
                       <input type="hidden" name="MM_insert" value="fexttype_add">
                        </form>
                    </div>
                </div>
            </div>
